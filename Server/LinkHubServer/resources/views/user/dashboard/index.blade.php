...
@section('subcontent')
    ...
    @if(count($links_in_queue) > 0)
        ...
        <form class="ui form" method="post" action="{{ url('home/link/'.$link_first->id) }}">
            {!! csrf_field() !!}
            ...
            <div class="field">
                <label>标签（空格分隔）</label>
                <input id="tags" type="text" name="tags" value="{{$link_first->tags}}">
                <div class="ui segment">
                    <p id='commonTags'>
            ...
            <div class="field">
                ...
                <div class="inline fields">
                    <div class="field">
                        <div class="ui radio checkbox">
                            <input type="radio" name="group" @if($link_first->group_id == 0)checked=""@endif tabindex="0" class="hidden" value="0">
                            <label>无分组</label>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        <div class="ui radio checkbox">
                            <input type="radio" name="group" @if($link_first->group_id == $group->id)checked=""@endif tabindex="0" class="hidden" value="{{$group->id}}">
